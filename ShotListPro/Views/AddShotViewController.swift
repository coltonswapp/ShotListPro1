...
class AddShotViewController :  UITableViewController, TextFieldCellDelegate {
    
    func valueDidChange(key: String, value: Any) {
        shotDict[key] = value
    }
    
    var shot = Shot(shotTitle: "", shotIsComplete: false, shotNotes: "", cameraForShot: "", lensForShot: "", shotLength: "", shotMood: "", numOfShots: "", shotSection: "", shotID: "", projectId: "")
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "Cancel", style: .plain, target: self, action: #selector(AddShotViewController.cancelShot))
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Create", style: .done, target: self, action: #selector(AddShotViewController.createShot))
